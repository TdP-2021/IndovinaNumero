...
public class FXMLController {
    ...
    void doTentativo(ActionEvent event) {
    	//lettura input dell'utente, controllo errori relativo a quello che l'utente inserisce nell'interfaccia
    ...
    public void setModel(Model model) {  //riceve dall'esterno un riferimento a un modello
    	this.model=model; 		//e lo setta nel suo modello
    }
